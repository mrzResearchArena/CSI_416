...
# Course Schedule
  ...
  - Week #2 :
    ...
    - Evaluation options on WEKA
      - use training dataset
      - supplied test dataset
      - cross-validation (KFold=10)
      - split dataset (2/3 train & 1/3 test)
    - Confusion Matrix
    - Assignment #1 : Choose all (25) datasets from WEKA & submit report on it.
  - Week #3 : 
    - Introduction to WEKA implementation in Java.
      - Assignment #2 : Two huge datasets provides & submit report on it.
  - Week #4 :
